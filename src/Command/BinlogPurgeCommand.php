...
#[AsCommand(name: 'purge-binlogs', description: 'Purge binary logs older than N days')]
final class BinlogPurgeCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('days', null, InputOption::VALUE_REQUIRED, 'Purge logs older than N days', '7')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            $this->runtime->binlogService()->purge($options);
            $output->writeln('<info>Binlogs purged</info>');
